...
export default function PwaInstaller() {
  ...
  return (
    <aside className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] left-3 right-3 z-[150] mx-auto max-w-sm rounded-2xl border border-cyan-400/20 bg-[var(--bg-card)]/95 p-3 text-white shadow-[0_20px_70px_rgba(0,0,0,0.65)] backdrop-blur-xl min-[]:left-auto min-[]:right-4">
      <button
        type="button"
